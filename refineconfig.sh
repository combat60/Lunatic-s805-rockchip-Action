...
sed -i 's/# CONFIG_PACKAGE_luci-app-passwall2_Iptables_Transparent_Proxy is not set/CONFIG_PACKAGE_luci-app-passwall2_Iptables_Transparent_Proxy=y/g' .config
sed -i 's/CONFIG_PACKAGE_luci-app-passwall2_Nftables_Transparent_Proxy=y/# CONFIG_PACKAGE_luci-app-passwall2_Nftables_Transparent_Proxy is not set/g' .config
sed -i 's/CONFIG_PACKAGE_libnetwork=y/# CONFIG_PACKAGE_libnetwork is not set/g' .config
sed -i 's/CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Trojan_Plus=y/# CONFIG_PACKAGE_luci-app-passwall2_INCLUDE_Trojan_Plus is not set/g' .config
sed -i 's/CONFIG_PACKAGE_perl-test-harness=y/# CONFIG_PACKAGE_perl-test-harness is not set/g' .config
